...
const Contact = () => {
    ...
    const postData = async () => {
        ...
        if (response.ok) {
            ...
            toast.error("Impossible de créer la nouvelle scène")
        }
                ...
                <form className="full_formulaire" onSubmit={handleSubmit} method="POST"
                    ...
                    <div className="email_hard_duration_div">
                        ...
                        <div className="selections">
                            <div>
                                <select required name="difficulties" value={selectedValue}
                            ...
                            <div>
                                <select required name="duration" value={selectedValue_2}
                                        onChange={handleSelectChange_2}>
                    ...
                    <div className="description_gameplay_contact_div">
                        <div className="under_div_scene">
                            ...
                            <textarea required className="textarea" placeholder="Votre description ici..."
                                      id="description-scene" name="description-scene"></textarea>
                        </div>

                        <div className="under_div_scene">
                            <label htmlFor="description-gameplay">Description du gameplay</label>
                            <textarea required className="textarea" placeholder="Votre explication du gameplay ici..."
